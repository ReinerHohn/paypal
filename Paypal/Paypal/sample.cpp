...
#include "..\..\soapPayPalAPISoapBindingProxy.h"  //#include "soapITransactionProcessorProxy.h" 
#include "PayPalAPISoapBinding.nsmap" //ITransactionProcessor.nsmap" 
#ifdef WIN32
...
const char *SERVER_URL = "https://api-3t.sandbox.paypal.com/2.0/"; // "https://ics2wstest.ic3.com/commerce/1.x/transactionProcessor";
...
#endif
	soap_wsse_add_UsernameTokenText(service.soap, NULL, "mi-dick_api1.gmx.de", "BXV8EFW5J7CQU4KP"); // TRANSACTION_KEY);
